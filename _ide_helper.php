...
namespace Illuminate\Support {
    ...
    class Collection {
         ...
         * 
         *
         * @see \App\Macros\CollectionMacros::toUpper()
         * @static 
         */
        public static function toUpper()
        {
            return \Illuminate\Support\Collection::toUpper();
        }
...
namespace Illuminate\Database\Eloquent {
    ...
    class Collection {
        ...
        public static function toUpper()
        {
            return \Illuminate\Database\Eloquent\Collection::toUpper();
        }
...
namespace Tymon\JWTAuth\Claims {
    ...
    class Collection {
        ...
        public static function toUpper()
        {
            return \Tymon\JWTAuth\Claims\Collection::toUpper();
        }
